...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.MicrosoftGraphAPIConnector;
 ...
 */
public class MicrosoftGraphAPIConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "MicrosoftGraphAPIConnector test case")
